...
motocycle = ["honda" , "suzuki" , "yohanda"]
print(motocycle) 
...
#task print a statemrnt: My name is Mojo Jojo and i own a motocycle plate_number
print("My name is " + motocycle_owner ,"and I own a motocycle" + motocycle[1] , plate_number[1] )
print(f"My name is {motocycle_owner} and l own {motocycle[1]} , {plate_number[1]}")
print(f"My name is {motocycle_owner} and l own {motocycle[1]} , platenumber{plate_number[1]}")
